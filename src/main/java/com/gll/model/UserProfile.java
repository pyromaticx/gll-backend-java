...
public class UserProfile {
	...
	public UserProfile(int userId, String userName, String userFirstName, String userLastName, StringBuffer userMedia,
			String userEmail, String userEmployer, String userDesignation, String userCity, String userState,
			boolean useStatus, String programId, String locId, Date timeUpdated) {
		super();
		this.userId = userId;
	...
	public StringBuffer getUserMedia() {
		return userMedia;
	}

	public void setUserMedia(StringBuffer userMedia) {
		this.userMedia = userMedia;
	}
	...
	public int hashCode() {
		...
		result = prime * result + ((userMedia == null) ? 0 : userMedia.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (userLastName == null) {
			...
			return false;
		if (userMedia == null) {
			if (other.userMedia != null)
				return false;
		} else if (!userMedia.equals(other.userMedia))
			return false;
		if (userName == null) {
	...
	public String toString() {
		return "UserProfile [userId=" + userId + ", userName=" + userName + ", userFirstName=" + userFirstName
				+ ", userLastName=" + userLastName + ", userMedia=" + userMedia + ", userEmail=" + userEmail
